...
def main():
    ...
    df_score=pd.concat([df_china['china_score'], df_taiwan['taiwan_score'],df_japan['japan_score'],df_india['india_score'],
    df_korea['south_korea_score'],df_singapore['singapore_score']], axis=1)
    print(df_score)
